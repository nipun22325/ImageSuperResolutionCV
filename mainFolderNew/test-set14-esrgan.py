...
test_img_folder = '/content/ImageSuperResolutionCV/mainFolderNew/images/set14/image_SRF_4/LR/*'
hr_img_folder = '/content/ImageSuperResolutionCV/mainFolderNew/images/set14/image_SRF_4/HR'  # Path to high-resolution ground truth images
...
for path in glob.glob(test_img_folder):
    ...
    hr_base = base.replace('LR', 'HR') if 'LR' in base else base
